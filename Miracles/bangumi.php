                            ...
                            foreach ($bgmlist as $bangumi) :
                                ...
                                <div class="bangumi-item col-md-4 col-lg-3 col-sm-6"><a
                                        ...
                                        <div class="bangumi-banner">
                                            ...
                                            $_bo = $db->fetchAll($db->select('value')->from('table.options')->where('name = %s', "theme:Miracles")->limit(1));
                                            $load_image = 'block';
                                            if (!empty($_bo[0]["value"]) && strpos($_bo[0]["value"], '"loading_image"') !== false) {
                                                $_bp = explode('"loading_image";', $_bo[0]["value"], 2);
                                                if (isset($_bp[1])) {
                                                    $_bp2 = explode('"', $_bp[1], 2);
                                                    if (isset($_bp2[1])) {
                                                        $_bp3 = explode('";', $_bp2[1], 2);
                                                        if (isset($_bp3[0])) { $load_image = $_bp3[0]; }
                                                    }
                                                }
                                            } ?>
