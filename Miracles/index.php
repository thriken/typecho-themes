 ...
 * @author      Eltrac
 * @version     1.6.0 fix
 * @link        https://guhub.cn & https://blog.elec.top
 */
...
?>
    <main class="main-container container" role="main">
      ...
      <div class="category-directory">
        <span class="category-directory-title"><i class="iconfont icon-block"></i> <?php gtecho('otherTexts', 'categoryTitle'); ?></span>
        <a href="<?php $this->options->siteUrl(); ?>" class="category-directory-item<?php if($this->is('index')): ?> active<?php endif; ?>"><?php gtecho('otherTexts', 'categoryAll'); ?></a>
        <?php while($categories->next()): ?>
        <a href="<?php $categories->permalink(); ?>" class="category-directory-item" title="<?php $categories->description(); ?>"><?php $categories->name(); ?></a>
        <?php endwhile; ?>
      </div>
      <?php endif; ?>
